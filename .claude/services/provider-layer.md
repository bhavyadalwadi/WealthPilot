...
## Responsibility
Aggregate market, news, earnings, and options data into normalized ticker snapshots.
...
- cache-backed snapshot reuse
- missing-field propagation into analysis context
